...
#                         initial_max=2, max_value=2, store="reg1_result.csv"
#                         )
#     sl.fit(x, y, x_dim=[dless, pa_dim, dless], y_dim=pa_dim)
#     print(sl.expr)
#     r2 = sl.score(x, y, "r2")
#     mae = sl.score(x, y, "neg_mean_absolute_error")
#     pre_y = sl.predict(x)
#
#     r = np.corrcoef(np.vstack((pre_y, y)))
...
#
#     sl = SymbolLearning(loop=r'MultiMutateLoop', cal_dim=True, dim_type=None,
#                         pop=1000, gen=20, add_coef=True, re_hall=2,store="reg2_result.csv",
